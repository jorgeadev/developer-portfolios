...
function HeroSection() {
	return (
		<section className="relative flex flex-col items-center justify-between py-4 lg:py-12">
			<Image
				src="/hero.svg"
				alt="Hero Image of Hieu Dat (Tedy Dev) - Portfolio Web Developer"
				width={1572}
				height={795}
			...
			<div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
				<div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
					...
					<div className="my-12 flex items-center gap-5">
						...
						<Link
							href={`https://mail.google.com/mail/u/0/#inbox?compose=new&mailto=hieudat2310.bh@gmail.com{personalData.gmail}`}
							target="_blank"
							className="transition-all text-pink-500 hover:scale-125 duration-300"
						>
					...
					<div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
						<code className="font-mono text-xs md:text-sm lg:text-base">
							...
							<div>
								...
								<span className="text-gray-400">{`'`}</span>
								<span className="text-amber-300">Tedy Dev</span>
								<span className="text-gray-400">{`',`}</span>
							</div>
							<div className="ml-4 lg:ml-8 mr-2">
								...
								<span className="text-gray-400">{"', '"}</span>
								<span className="text-amber-300">Entity Framework Core</span>
								<span className="text-gray-400">{"', '"}</span>
								<span className="text-amber-300">ASP.NET Core MVC</span>
								<span className="text-gray-400">{"', '"}</span>
