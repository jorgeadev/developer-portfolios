			...
			<div className="flex flex-col items-center justify-between w-full h-full">
				...
				<div className="p-6">
					<Image
						...
						width={1080}
						height={720}
						className="w-80 h-64 transition-opacity duration-700 delay-300 rounded-lg group-hover:opacity-0"
					/>
				</div>
				<div className="flex items-center justify-between w-full">
					<Link
						href={demo}
						target="_blank"
						className="flex justify-center items-center w-10 h-10 rounded-full border-2 border-[#EFF3F4] text-[#EFF3F4] transition-all duration-300 hover:bg-[#231d4b] hover:text-violet-600 hover:border-[#0F0C41] hover:scale-110 box-decoration-clone cursor-pointer no-underline delay-300"
					>
						<FaPlay />
					</Link>
					...
					<Link
						href={code}
						target="_blank"
						className="flex justify-center items-center w-10 h-10 rounded-full border-2 border-[#EFF3F4] text-[#EFF3F4] transition-all duration-300 hover:bg-[#231d4b] hover:text-violet-600 hover:border-[#0F0C41] hover:scale-110 cursor-pointer no-underline  delay-300 group-hover:-translate-x-35"
					>
						<FaCode />
					</Link>
				</div>
			</div>
			<p className="absolute w-[90%] md:w-[85%] md:min-h-37.5 translate-x-[-110%] transition-transform duration-[0.9s] p-6 leading-[110%] rounded-[0_20px_20px_0] left-0 top-0 bg-[#0f0b24]  text-[#EFF3F4] translate-y-[25%] md:translate-y-[50%] group-hover:translate-x-[-2%] text-xs md:text-sm">
				{description}
			</p>
			<div className="group-hover:translate-x-0 absolute w-35 text-[0.8rem] flex justify-center gap-2 flex-col translate-x-full transition-transform duration-500 delay-300 p-[0.825rem] rounded-[10px_0_0_10px] right-0 bottom-4 bg-[#0f0b24] text-[#EFF3F4]">
				{tags.map((tag, id) => (
					<span className="font-medium wrap-break-word text-xs" key={id}>
						{tag}
					</span>
				))}
			</div>
